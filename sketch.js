...
var theme,splash,laughter,explosion;
...
theme = loadSound("assets/background_music.mp3");
splash = loadSound("splash.mp3");
laughter = loadSound("assets/pirate_laugh.mp3");
  ...
  if (boats.length > 0) {
    ...
    for (var i = 0; i < boats.length; i++) {
      ...
      if (collision.collided && !boats[i].isBroken) {
        if(!isLaughing && !laughter.isPlaying()){
          laughter.play();
          isLaughing=true;
        }
        isGameOver = true;
